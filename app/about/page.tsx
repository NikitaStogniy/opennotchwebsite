            ...
            <div className="relative">
              ...
              <div className="flex gap-3">
                <MagneticButton
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-black text-white rounded-lg hover:bg-gray-800 transition-all font-medium shadow-lg hover:shadow-xl"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {coreValues.map((value, index) => (
              <ParallaxCard
                key={value.name}
                speed={0.3 + index * 0.1}
                className={`relative p-8 bg-gradient-to-br ${value.gradient} rounded-3xl border-2 border-gray-200/50 hover:border-gray-300 transition-all group`}
              >
                <div className={`absolute inset-x-0 top-0 h-1 bg-gradient-to-r ${value.borderGradient} opacity-0 group-hover:opacity-100 transition-opacity rounded-t-3xl`} />
